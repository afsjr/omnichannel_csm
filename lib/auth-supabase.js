...
if (!supabaseUrl || !supabaseKey) {
  console.warn('⚠️ Supabase Auth não configurado (SUPABASE_URL ou SUPABASE_SERVICE_KEY faltando)');
}

const supabase = createClient(supabaseUrl, supabaseKey, ws ? { realtime: { transport: ws } } : {});
